...
const Footer = () => {
  return (
    <div className="max-w-[1370px] mx-auto mt-12 grid grid-cols-3 w-full px-4 gap-8">
      ...
      <div>
        ...
        <div className="flex flex-row mt-3  border-[1.5px] border-[#d4d7da] h-[45px] max-w-[350px] pl-4 rounded-lg -z-50 gap-3">
          <input
            type="text"
